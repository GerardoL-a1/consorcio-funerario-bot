...
return responder(""" Escribe la letra correspondiente para más información o *volver* para regresar.""")
...
AL. Camión foráneo por km
        ...
        return responder("📝  Escribe la letra del plan o servicio que deseas consultar (por ejemplo A, b, AL, etc).")
