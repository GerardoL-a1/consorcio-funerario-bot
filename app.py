...
def webhook():
    ...
    if not estado:
        if contiene(claves_emergencia, msj_lower):
            ...
            return responder("🤖 No entendí tu mensaje. Por favor elige una opción del menú o escribe 'menú' para volver a comenzar.")
    ...
    if estado.get("submenu"):
        ...
        if letra in selecciones_letras:
            ...
            return responder("❌ No reconocimos tu selección. Intenta con otra letra o palabra clave. También puedes escribir *menú* para comenzar de nuevo.")
